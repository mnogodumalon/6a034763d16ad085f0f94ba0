...
const MATERIAL_FIELDS = [
  ...
  { key: 'einheit', label: 'Einheit', type: 'lookup/select', options: [{ key: 'stueck', label: 'Stück' }, { key: 'meter', label: 'Meter' }, { key: 'liter', label: 'Liter' }, { key: 'kilogramm', label: 'Kilogramm' }, { key: 'quadratmeter', label: 'Quadratmeter' }, { key: 'kubikmeter', label: 'Kubikmeter' }, { key: 'rolle', label: 'Rolle' }, { key: 'paket', label: 'Paket' }, { key: 'sack', label: 'Sack' }] },
...
const MITARBEITER_FIELDS = [
  { key: 'mitarbeiter_vorname', label: 'Vorname', type: 'string/text' },
  { key: 'mitarbeiter_nachname', label: 'Nachname', type: 'string/text' },
  { key: 'gewerk', label: 'Gewerk', type: 'lookup/select', options: [{ key: 'maler', label: 'Maler' }, { key: 'elektriker', label: 'Elektriker' }, { key: 'schreiner', label: 'Schreiner' }, { key: 'sanitaer', label: 'Sanitär' }, { key: 'fliesenleger', label: 'Fliesenleger' }, { key: 'maurer', label: 'Maurer' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'stundensatz', label: 'Stundensatz (€/h)', type: 'number' },
  { key: 'telefon_mitarbeiter', label: 'Telefon', type: 'string/tel' },
  { key: 'email_mitarbeiter', label: 'E-Mail', type: 'string/email' },
];
const AUFTRAEGE_FIELDS = [
  ...
  { key: 'status', label: 'Status', type: 'lookup/select', options: [{ key: 'offen', label: 'Offen' }, { key: 'in_bearbeitung', label: 'In Bearbeitung' }, { key: 'abgeschlossen', label: 'Abgeschlossen' }, { key: 'abgerechnet', label: 'Abgerechnet' }, { key: 'storniert', label: 'Storniert' }] },
  { key: 'beschreibung', label: 'Auftragsbeschreibung', type: 'string/textarea' },
  { key: 'kunde', label: 'Kunde', type: 'applookup/select', targetEntity: 'kunden', targetAppId: 'KUNDEN', displayField: 'vorname' },
  { key: 'mitarbeiter_auftrag', label: 'Mitarbeiter', type: 'applookup/select', targetEntity: 'mitarbeiter', targetAppId: 'MITARBEITER', displayField: 'mitarbeiter_vorname' },
  { key: 'arbeitsstunden', label: 'Arbeitsstunden (h)', type: 'number' },
  { key: 'material_auftrag', label: 'Material', type: 'applookup/select', targetEntity: 'material', targetAppId: 'MATERIAL', displayField: 'bezeichnung' },
  { key: 'materialmenge', label: 'Menge', type: 'number' },
  { key: 'anfahrtspauschale', label: 'Anfahrtspauschale (€)', type: 'number' },
  { key: 'zusatzkosten', label: 'Zusatzkosten (€)', type: 'number' },
  { key: 'notizen_auftrag', label: 'Notizen zum Auftrag', type: 'string/textarea' },
];
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'auftraege' && fieldKey === 'mitarbeiter_auftrag') {
      const match = (lists.mitarbeiterList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.mitarbeiter_vorname ?? '—';
    }
    if (entity === 'auftraege' && fieldKey === 'material_auftrag') {
