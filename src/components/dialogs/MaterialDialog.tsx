...
interface MaterialDialogProps {
  ...
  defaultValues?: Material['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function MaterialDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: MaterialDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'material');
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "bezeichnung": string | null, // Bezeichnung\n  "einheit": LookupValue | null, // Einheit (select one key: "stueck" | "meter" | "liter" | "kilogramm" | "quadratmeter" | "kubikmeter" | "rolle" | "paket" | "sack") mapping: stueck=Stück, meter=Meter, liter=Liter, kilogramm=Kilogramm, quadratmeter=Quadratmeter, kubikmeter=Kubikmeter, rolle=Rolle, paket=Paket, sack=Sack\n  "preis_pro_einheit": number | null, // Preis pro Einheit (€)\n  "notizen_material": string | null, // Notizen\n}`;
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="kubikmeter">Kubikmeter</SelectItem>
