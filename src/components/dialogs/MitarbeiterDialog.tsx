...
export function MitarbeiterDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: MitarbeiterDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "mitarbeiter_vorname": string | null, // Vorname\n  "mitarbeiter_nachname": string | null, // Nachname\n  "gewerk": LookupValue | null, // Gewerk (select one key: "maler" | "elektriker" | "schreiner" | "sanitaer" | "fliesenleger" | "maurer" | "sonstiges") mapping: maler=Maler, elektriker=Elektriker, schreiner=Schreiner, sanitaer=Sanitär, fliesenleger=Fliesenleger, maurer=Maurer, sonstiges=Sonstiges\n  "stundensatz": number | null, // Stundensatz (€/h)\n  "telefon_mitarbeiter": string | null, // Telefon\n  "email_mitarbeiter": string | null, // E-Mail\n}`;
